...
| ----------- | ------------------------------------------------------------------ | -------- | ------------------ |
| Claude Code | [`.claude/settings.json`](.claude/settings.json)                   | v2.1.274 | v2.1.231 and later |
| OpenCode    | [`.config/opencode/opencode.json`](.config/opencode/opencode.json) | v1.18.32 | v1.18.25 and later |
