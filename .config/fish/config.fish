...
set -gx CLAUDE_ENABLE_STREAM_WATCHDOG 1
set -gx CLAUDE_CODE_RETRY_WATCHDOG 1
set -gx CLAUDE_CODE_RESUME_INTERRUPTED_TURN 1
set -gx CLAUDE_CODE_RESUME_INTERRUPTED_TURN_MAX_AGE_MS 21600000

# Updater settings
set -gx DISABLE_UPDATES 1
set -gx DISABLE_AUTOUPDATER 1
set -gx FORCE_AUTOUPDATE_PLUGINS 0
...
set -gx CLAUDE_CODE_SIMPLE_SYSTEM_PROMPT 1

# TUI behavior
set -gx CLAUDE_CODE_ENABLE_AWAY_SUMMARY 0
set -gx CLAUDE_CODE_ENABLE_PROMPT_SUGGESTION false
set -gx CLAUDE_CODE_ENABLE_TASKS 1
set -gx CLAUDE_AGENT_SDK_DISABLE_BUILTIN_AGENTS 1
set -gx CLAUDE_CODE_ENABLE_TODO_TOOLS 1
set -gx CLAUDE_CODE_DISABLE_GIT_INSTRUCTIONS 1
...
set -gx CLAUDE_CODE_MAX_TOOL_USE_CONCURRENCY 6
...
set -gx OPENCODE_DISABLE_DEFAULT_PLUGINS false
set -e OPENCODE_DISABLE_EXTERNAL_SKILLS
set -e OPENCODE_FAST_BOOT
